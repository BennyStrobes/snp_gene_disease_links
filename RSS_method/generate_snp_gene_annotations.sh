...
for chrom_num in $(seq 1 22); do 
	echo $chrom_num
	python3 identify_k_closest_genes_to_each_snp.py $baselineLD_anno_dir $gene_annotation_file $K_closest_genes $chrom_num $hapmap3_rsid_file $snp_gene_annotation_dir
done
