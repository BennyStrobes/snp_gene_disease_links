...
snp_set="assymetric_snps"
for chrom_num in $(seq 1 22); do 
	python3 generate_ld_matrices_for_ld_windows_on_single_chromosome.py $chrom_num $genome_wide_ld_windows_file $hapmap3_rsid_file $baselineLD_anno_dir $kg_plink_dir $snp_set $processed_ld_data_dir $gwas_traits_file $sumstat_dir
done
