...
def extract_hm3_rsids(hapmap3_rsid_file, chrom_num):
...
#############
# Dictionary list of hapmap3 rsids on this chromosome
hm3_rsids = extract_hm3_rsids(hapmap3_rsid_file, chrom_num)
